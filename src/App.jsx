  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path={ROUTES.CHAT}
          // path="/chat" — customer full-page assistant, publicly
          // reachable (same guest-or-logged-in access as the floating
          // widget itself — no ProtectedRoute wrapper needed here)
          element={
            <Suspense fallback={<PageLoader />}>
              <ChatPage />
            </Suspense>
