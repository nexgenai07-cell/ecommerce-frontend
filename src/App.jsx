    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          {/* PAYMENT_RESULT — reached either via Stripe's redirect-based
              3D Secure flow (full browser navigation, no React state
              survives) or via a client-side navigate() call from the
              checkout page for non-redirect flows. Must stay protected
              like the rest of checkout, since it displays order info. */}
          <Route
