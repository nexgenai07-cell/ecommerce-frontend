...
const Register = () => {
  ...
  // =============================================
  // GOOGLE SIGN-IN — fully functional (replaces the old
  // "Google OAuth coming soon" placeholder button). Renders the real,
  // official Google button into the "google-signin-button-register"
  // container below. Uses a DIFFERENT container id than Login.jsx so
  // both pages can each mount their own Google button independently.
  // See src/hooks/useGoogleSignIn.js for the full implementation —
  // sign-up and sign-in are the same backend endpoint, the backend
      ...
      {verificationSent ? (
        ...
        <div className="flex flex-col gap-8 ">
          ...
          >
            ...
            {/*
              Real Google Sign-In button, rendered directly by Google
              Identity Services via the useGoogleSignIn hook above. This
              div is intentionally left empty in the JSX — Google injects
              its own button markup into it at runtime. "flex justify-center"
              centers Google's button the same way the old placeholder
              Button (fullWidth) filled the row.
            */}
            <div
