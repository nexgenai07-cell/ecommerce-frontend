...
// ----------------------------------------------------------------------------
// This is the "Order Summary" card shown on the right side of the Cart page.
// It shows the price breakdown (subtotal, discount, shipping, total), lets the
// customer apply or remove a coupon code, shows a "Proceed to Checkout" button,
// and displays payment method icons + trust badges at the bottom.
// All prices and coupon actions come from the real backend API — nothing here
// is fake data except the static payment icon labels and trust badge text.
// ============================================================================
